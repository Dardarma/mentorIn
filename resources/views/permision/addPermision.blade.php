            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-1 px-0">
                        <a href="{{ asset('/admin/permision/list') }}" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i></a>
                    </div>
                    <div class="col-7">
                        <h3>Tambah Permision</h3>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Permision">
                        </div>
                    </div>
                    <div class="col-8">
                        <div class="form-group">
...
<script>
    ...
    document.getElementById('confirmButton').addEventListener('click', function() {
        // Logika untuk menambahkan permision di sini
